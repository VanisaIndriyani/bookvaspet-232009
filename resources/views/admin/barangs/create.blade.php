    ...
    <div class="bg-gradient-to-r from-pink-600 to-pink-500 text-white rounded-2xl p-6 shadow-lg">
        <div class="flex items-start space-x-4">
            ...
            <div>
                ...
                <h2 class="text-2xl font-semibold">Tambah Barang Baru</h2>
                <p class="text-sm text-white/80 mt-1">Pastikan kode barang unik dan informasi lengkap.</p>
            </div>
        </div>
    </div>

    <div class="bg-white shadow-xl rounded-2xl p-8">
        <form action="{{ route('admin.barangs.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid gap-6 md:grid-cols-3">
                ...
                <div>
                    ...
                    <input type="text" name="nama_barang" id="nama_barang" value="{{ old('nama_barang') }}"
                           class="w-full border border-gray-200 rounded-xl px-4 py-3 shadow-sm focus:border-pink-500 focus:ring-pink-500"
                           placeholder="Contoh: Obat Anti Kutu" required>
                ...
                <div>
                    ...
                    <input type="text" name="jenis_barang" id="jenis_barang" value="{{ old('jenis_barang') }}"
                           class="w-full border border-gray-200 rounded-xl px-4 py-3 shadow-sm focus:border-pink-500 focus:ring-pink-500"
                           placeholder="Contoh: Obat" required>
            ...
            <div class="rounded-2xl bg-pink-50 border border-pink-100 p-4 text-sm text-pink-800 flex items-start space-x-3">
                ...
                <p>Data barang yang baru akan langsung muncul pada daftar utama begitu Anda menyimpan perubahan.</p>
            </div>
