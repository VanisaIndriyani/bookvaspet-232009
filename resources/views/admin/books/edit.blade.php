    ...
    <div class="bg-gradient-to-r from-pink-600 to-pink-500 text-white rounded-2xl p-6 shadow-lg">
        <div class="flex items-start space-x-4">
            ...
            <div>
                ...
                <h2 class="text-2xl font-semibold">Edit Data Buku</h2>
                <p class="text-sm text-white/80 mt-1">Perbarui informasi kode buku, pengarang, dan penulis sesuai kebutuhan.</p>
            </div>
        </div>
    </div>
        ...
        <form action="{{ route('admin.books.update', $book) }}" method="POST" class="space-y-6">
            ...
            <div class="grid gap-6 md:grid-cols-3">
                ...
                <div>
                    ...
                    <input type="text" name="nama_pengarang" id="nama_pengarang" value="{{ old('nama_pengarang', $book->nama_pengarang) }}"
                           class="w-full border border-gray-200 rounded-xl px-4 py-3 shadow-sm focus:border-pink-500 focus:ring-pink-500"
                           required>
                ...
                <div>
                    ...
                    <input type="text" name="nama_penulis" id="nama_penulis" value="{{ old('nama_penulis', $book->nama_penulis) }}"
                           class="w-full border border-gray-200 rounded-xl px-4 py-3 shadow-sm focus:border-pink-500 focus:ring-pink-500"
                           required>
